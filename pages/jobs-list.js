                                ...
                                <div className="col-lg-9 col-md-12 col-sm-12 col-12 float-right">
                                    <div className="content-page">
                                        ...
                                        <div className="row display-list">
                                           {job.map((data)=>{
                                        const {j_description , j_position,j_status}=data
                                        return(<>
                                        ...
                                        <div className="col-xl-12 col-12">
                                                <div className="card-grid-2 hover-up">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12">
                                                            <div className="card-grid-2-image-left">
                                                                ...
                                                                <div className="right-info">
                                                                    <Link legacyBehavior href="#">
                                                                        <a className="name-job">{j_status}</a>
                                                                    </Link>
                                                    ...
                                                    <div className="card-block-info">
                                                        ...
                                                        <p className="font-sm color-text-paragraph mt-10">{j_description}</p>
                                                    ...
                                                    <div className="box-number-money">
                                                        <div className="row mt-30">
                                                            ...
                                                            <div className="col-sm-6 col-6 text-end">
                                                                <span className="font-sm color-brand-1">Rs.85000</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
